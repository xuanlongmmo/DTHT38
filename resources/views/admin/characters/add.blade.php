...
@section('content')
    <div class="page-header d-lg-flex d-block">
        <div class="page-leftheader">
            <h4 class="page-title">Thêm nhân vật
    ...
    <form action="{{ route('characters.store') }}" id="characterForm" method="POST">
        @csrf
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-header border-bottom-0">
                        <h4 class="card-title">nhân vật</h4>
                    </div>
                        ...
                        <div id="artifact" class="row">
                            <div class="col-lg-10 col-md-8">
                                <div class="form-group">
                                    ...
                                    <input style="margin-bottom: 5px" type="text" name="name" id="name" value="{{ old('name') }}" class="form-control" placeholder="Nhập tên nhân vật">
                                    <span style="display: block" id="spanslug">Đường dẫn: {{ URL::to('/'); }}/nhan-vat/<span id="slug">{{ old('slug') }}</span>/<button onclick="return changeinput()" class="button-white" id="editslug" type="button">Sửa</button></span>
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="editorartifact">Nội dung nhân vật<span class="text-red">*</span></label>
        ...
        <div class="row">
            <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="buttondiv">
                        <button type="button" onclick="return submitback('characterForm')" class="btn btn-primary btncus">Lưu nhân vật và thoát</button>
                        @if (isset($_GET['next']) && $_GET['next'] == 1)
                            <button onclick="return submitnext('characterForm')" class="btn btn-secondary btncus">Lưu và sang bước tiếp theo</button>
                        @else
